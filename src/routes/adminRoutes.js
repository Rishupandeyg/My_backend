// ======================================================
// 🚀 ADMIN — GET ALL PAID CANDIDATES
// ======================================================
import PaidCandidate from "../models/PaidCandidate.js";  // ⭐ IMPORTANT

router.get("/paid-candidates", auth, async (req, res) => {
  if (req.user.role !== "admin")
    return res.status(403).json({ msg: "Access denied: Admins only" });

  try {
    const paidList = await PaidCandidate.find()
      .populate("candidateId", "firstName lastName email mobile city state category") // Candidate details
